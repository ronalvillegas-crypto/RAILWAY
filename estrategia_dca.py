        ...
        try:
            ...
            if señal_backtesting:
                ...
                return {
                    ...
                    'zona_actual': 'SUPPORT' if señal_backtesting['direccion'] == 'COMPRA' else 'RESISTANCE',
                    'motivo_señal': f"Señal Backtesting S/R Perfecta - {señal_backtesting['direccion']}"
                }
            
            # 🎯 SEGUNDO: Estrategia Original (como fallback)
            print(f"🔍 Backtesting no detectó señal para {par}, usando estrategia original")
            return self.generar_señal_real(par)
