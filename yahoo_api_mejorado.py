...
class YahooFinanceAPI:
    ...
    def _obtener_precio_twelvedata(self, simbolo: str):
        ...
        try:
            ...
            td_symbols = {
                ...
                "SPX500": "SPX", "NAS100": "NAS100", "GBPUSD": "GBP/USD"
            }
    ...
    def _obtener_precio_alphavantage(self, simbolo: str):
        ...
        try:
            ...
            if simbolo not in ['EURUSD', 'XAUUSD', 'SPX500', 'GBPUSD']:
                return None
    ...
    def _obtener_precio_fallback(self, simbolo: str):
        ...
        precios_base = {
            ...
            "DJI30": 39000.0, "GER40": 18000.0, "UK100": 7700.0, "JPN225": 38000.0
        }
